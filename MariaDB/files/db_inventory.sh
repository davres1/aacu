#!/usr/bin/env bash
# db_inventory.sh — Ansible facts.d collector for MariaDB / MariaDB.
#
...
# generator and PDF inventory section parse it uniformly. TOP-LEVEL KEY IS "mariadb":
#   {"hostname","computer_name","fqdn","collected_at",
#    "mariadb": {"<host>\\<instance>": {"instance_name","version","edition",
